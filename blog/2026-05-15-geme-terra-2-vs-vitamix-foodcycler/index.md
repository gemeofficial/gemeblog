...
Australian consumer advocacy group [CHOICE awarded the Breville FoodCycler a Shonky Award](https://www.choice.com.au/shonky-awards/hall-of-shame/shonkys-2021/breville-foodcycler/) in 2021, calculating that *"the cost of replacing the filters and other parts"* ran to **"\$223 a year."** Combined with energy costs of about \$86 a year and the initial \$499 purchase price, CHOICE estimated that over a five-year period **"the FoodCycler would set you back about \$2000."** Even Breville's own response to CHOICE, documented by [Appliance Retailer](https://www.applianceretailer.com.au/breville-responds-to-choices-shonky-award-claims/), acknowledged filter costs of around \$120 per year under typical usage, with the company noting that *"a typical household running the machine three to five times per week will likely require filter replacements every three to six months."*
...
> A:  The answer varies with usage, but documented costs range from approximately \$120 per year under moderate use (based on [Breville's own estimate](https://www.applianceretailer.com.au/breville-responds-to-choices-shonky-award-claims/)) to \$223 per year (based on [CHOICE's independent calculation](https://www.choice.com.au/shonky-awards/hall-of-shame/shonkys-2021/breville-foodcycler/)) to as much as \$300 per year for households processing wet, heavy food waste loads (based on [HappiestKitchen's documented user report](https://www.happiestkitchen.com/post/detail/182/)). These costs are exclusively for replacement carbon filters, which are consumable parts that must be replaced every few months.

### Q: Which electric kitchen composter is best for a large family?

> A: The GEME Terra 2 is better suited for larger households. Its 14L chamber and 2 kg daily processing capacity accommodate the food waste output of up to five people. The continuous-feed design means multiple family members can add scraps throughout the day without coordinating around a batch cycle. The machine runs 24/7 in the background and can handle the full range of kitchen waste a large household generates, including meat, dairy, and small bones, without odor issues or filter replacements.
...
2. The Compost Culture. (2023, August). [*GEME Electric Kitchen Composter Review*](https://www.thecompostculture.com/geme-electric-kitchen-composter-review/).

3. Reviewed.com. (2023, June). [*This Small Appliance Turns Food Scraps Into Gardening Gold, and We Love It*](https://www.reviewed.com/cooking/content/vitamix-eco-5-foodcycler-review).

4. Breville. (n.d.). [*the FoodCycler® Product Page*](https://www.breville.com/en-au/product/bwr550).

5. Reencle Singapore. (2024, November). [*Why Dehydrated Food Waste Isn't a Real Compost*](https://www.reencle.com.sg/post/why-dehydrated-food-waste-isn-t-a-real-compost)

6. HappiestKitchen. (2025, November). [*Beyond the 'Start' Button: The Science of Moisture and Cost in Food Recyclers*](https://www.happiestkitchen.com/post/detail/182/

7. CHOICE Australia. (2021, November). *Breville FoodCycler — Shonky Awards*. https://www.choice.com.au/shonky-awards/hall-of-shame/shonkys-2021/breville-foodcycler/).

8. Appliance Retailer. (2021, November). [*Breville Responds to CHOICE's Shonky Award Claims*](https://www.applianceretailer.com.au/breville-responds-to-choices-shonky-award-claims/).

9. Amazon.ca Customer Review. (2024, January). [*Vitamix FoodCycler Replacement 2-Pack Filter*](https://arcus-www.amazon.ca/gp/customer-reviews/R26VS3DWSNA4PZ?ASIN=B08QTSPBDQ)
...
15. Kitchen Compost Bins. (2025, December). [*GEME Terra 2: Pros, Cons & Verdict*](https://kitchencompostbins.com/geme-terra-2-pros-cons-verdict-2/).
